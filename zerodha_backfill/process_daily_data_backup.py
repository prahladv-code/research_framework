...
def process_daily_data(start_date: datetime.date, end_date: datetime.date, instruments, backfill, today):
    ...
    for instrument in instruments:
        ...
        if instrument_type == 'FUT':
            ...
            ingest_folder = r"C:\Users\Admin\Desktop\zerodha_backfills\FUT"
            ...
            ingest_folder = r"C:\Users\Admin\Desktop\zerodha_backfills\SPOT"
            name = instrument.get('name')
            underlying = underlying_map.get(name)
            token = instrument.get('instrument_token')
            spot_data = backfill.get_historical_data(kite, token, start_date, end_date)
            if spot_data is not None and not spot_data.empty:
                spot_path = os.path.join(ingest_folder, f'IDX_{underlying}.csv')
        ...
        if instrument_type in ('CE', 'PE'):
            ...
            ingest_folder = r"C:\Users\Admin\Desktop\zerodha_backfills\OPT"
            opt_data = None
    ...
    ingest_opt_folder = r"C:\Users\Admin\Desktop\zerodha_backfills\OPT"
...
if __name__ == '__main__':
    ...
    while True:
        try:
            process_daily_data(start_date, end_date, instruments, backfill, today)
