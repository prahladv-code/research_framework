...
class PRICEMA:
    ...
    def gen_signals(self):
        ...
        for self.row in iterable:
            ...
            #ENTRY
            if self.row.close > self.row.ma and not self.wait_for_cross:
            ...
            if self.row.close > self.row.chandelier_short and self.in_position == -1:
            ...
            if self.row.close < self.row.chandelier_long and self.in_position == 1:
                self.exit_price = self.row.close
                self.exit_trade = 'SELL'
                signals_list.append(
                                {
    ...
    def create_backtest(self, uid: str):
        ...
        tradesheet.to_parquet(f'C:/Users/admin/VSCode/research/research_framework/tradesheets/pricema_atr_exit/{uid}.parquet')
